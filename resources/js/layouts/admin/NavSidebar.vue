<template>
    <div class="flex bg-transparent text-main absolute">
        ...
        >
            ...
            <nav class="flex flex-1 flex-col gap-y-4 pt-10">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                class="absolute inset-0 -left-1 flex items-center"
                            >
                ...
                >
                    <ScrollText class="h-6 w-6 stroke-current" />
                    <div
                        class="absolute inset-y-0 left-12 hidden items-center group-hover:flex"
                    >
                        <div
            ...
            >
                <button
                    class="mt-2 rounded-full bg-main"
                    @click="toggle(!value)"
                >
                    <img
                ...
                >
                    ...
                    <button :disabled="loading" class="" @click="logout">
