<template>
    ...
    >
        ...
        <button
          ...
          "
          class="inline-flex items-center border-b-2 border-transparent pt-4 pl-1 text-sm font-medium text-muted-foreground hover:border-gray-300 hover:text-gray-700"
        >
