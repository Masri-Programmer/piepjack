    ...
    >
        ...
        <div class="max-w-4xl space-y-16">
            <div class="grid md:grid-cols-2 gap-12">
                <div class="border-l-8 border-main pl-6">
                    <p class="text-2xl leading-tight font-bold text-foreground italic uppercase tracking-tighter">
                        {{ $t("pages.shipping.tracking_info_header") }}
                    </p>
                </div>
                <p class="text-sm leading-relaxed text-muted-foreground uppercase tracking-widest font-medium">
                    {{ $t("pages.shipping.tracking_info_description") }}
                </p>
            </div>

            <div class="w-full overflow-hidden border-4 border-border bg-background">
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse text-left">
                        <thead>
                            <tr class="bg-main text-accent uppercase text-xs tracking-[0.2em] font-bold">
                                <th class="p-6 border-r-2 border-accent/20">
                                    {{ $t("pages.shipping.table.country") }}
                                </th>
                                <th class="p-6 border-r-2 border-accent/20 text-center">
                        ...
                        <tbody class="divide-y-4 divide-border">
                            <tr class="hover:bg-muted transition-colors group">
                                <td class="p-6 font-bold uppercase italic border-r-2 border-border text-lg">
                                    {{ $t("pages.shipping.countries.germany") }}
                                </td>
                                <td class="p-6 text-center border-r-2 border-border font-mono text-lg">2-4</td>
                                <td class="p-6 text-center border-r-2 border-border font-bold text-lg">€3,95</td>
                                <td class="p-6 text-center font-bold text-main whitespace-nowrap">
                            ...
                            <tr class="hover:bg-muted transition-colors group">
                                ...
                                <td class="p-6 text-center border-r-2 border-border font-mono text-lg">2-4</td>
                                <td class="p-6 text-center border-r-2 border-border font-bold text-lg">€4,95</td>
                                <td class="p-6 text-center font-bold text-main whitespace-nowrap">
                                    {{ $t("pages.shipping.over") }} €70
                                </td>
                            </tr>
                            <tr class="hover:bg-muted transition-colors group">
                                ...
                                <td class="p-6 text-center border-r-2 border-border font-mono text-lg">3-5</td>
                                <td class="p-6 text-center border-r-2 border-border font-bold text-lg">€9,99</td>
                                <td class="p-6 text-center opacity-30 font-bold">—</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="p-8 bg-muted border-2 border-border text-center relative overflow-hidden">
                <div class="relative z-10">
                    <p class="font-bold uppercase tracking-widest text-sm italic text-foreground">
