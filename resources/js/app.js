...
import { i18n, createQueryClient, toastOptions, checkShutdownCode } from '@lib/config';

// if (typeof checkShutdownCode === 'function') { // Good practice to check if function exists
//     checkShutdownCode();
// }
