export default {
    ...
    tos: {
        ...
        last_updated: "As of: 29.08.2023 // PIEPJACK LEGAL DEPT.",
    ...
    privacy: {
        ...
        last_updated: "Privacy // As of: 08.04.2026",
    ...
    checkout: {
        ...
        free: "Free",
        total: "Total",
        includingTaxes: "Including {taxAmount} in taxes",
    ...
    faq: {
        ...
        track_order_answer: "You can track your order here.",
    ...
    shipping: {
        ...
        tracking_info_description:
            "After you have placed your order, you will receive a confirmation email with all the details of your purchase, including a tracking number.",
        table: {
            country: "Country",
