...
export const apiQuery = (resource) => {
    ...
    const { handleError: handleAdminError, handleSuccess: handleAdminSuccess } = useApiNotifications();
    const { handleError: handleShopError, handleSuccess: handleShopSuccess } = useApiShopNotifications();

    const area = localStorage.getItem('area');
    const handleError = area === 'admin' ? handleAdminError : handleShopError;
    const handleSuccess = area === 'admin' ? handleAdminSuccess : handleShopSuccess;
