        ...
        >
            ...
            <div class="absolute size-full backface-hidden">
                <img
                    :src="props.image"
                    alt="image"
                    class="size-full object-cover shadow-2xl shadow-accent_dark/40"
                />
                <div
                    class="absolute bottom-4 left-4 text-xl font-bold text-accent"
                >
                    {{ props.title }}
                </div>
            </div>
            ...
            <div
                :class="
                    cn(
                        'absolute h-full w-full bg-accent_dark/80 p-4 text-main backface-hidden',
                        rotation[1],
                    )
                "
            >
