<template>
    ...
    >
        <div
            v-if="!isLoading"
            class="space-y-24 md:space-y-32 animate-in fade-in zoom-in-95 duration-700"
        >
            <div
                class="border-[12px] border-main bg-background p-12 sm:p-20 text-center relative overflow-hidden"
            >
                <!-- Decorative background element -->
                <div
                    class="absolute -right-8 -top-8 w-32 h-32 bg-accent_light rotate-12 opacity-50"
                ></div>

                <div class="relative z-10">
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 bg-main text-accent mb-8 rounded-none"
                    >
                        <Check class="w-10 h-10" stroke-width="3" />
                    </div>

                    <h1
                        class="text-4xl sm:text-6xl font-bold uppercase tracking-tighter italic leading-none text-foreground mb-6"
                    >
                        {{ $t("common.return.success_title") }}
                    </h1>

                    <p
                        class="text-xl font-bold uppercase tracking-widest text-main mb-2"
                    >
                        #{{ returnNumber }}
                    </p>
                    ...
                    <p
                        class="text-lg font-medium text-muted-foreground max-w-md mx-auto leading-relaxed"
                    >
            ...
            <div v-if="data?.data" class="space-y-12">
                <div class="flex items-center gap-4">
                    ...
                    <h2
                        class="text-2xl font-bold uppercase italic tracking-tight shrink-0"
                    >
