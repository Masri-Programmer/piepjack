<template>
  ...
  <aside class="w-full md:w-1/3 lg:w-1/4">
    <div class="sticky top-12 flex flex-col gap-6">
      ...
      <div v-else class="underline uppercase text-orange-300 text-sm">
          ...
          <Table
            ...
            :rows="[
              [
                {
                  ...
                  alt: 'Germany Flag',
                  text: $t('common.product.shippingInfo.germany'),
                },
                $t('common.product.shippingInfo.germanyDelivery'),
                '€3.95',
                `${$t(
              ...
              [
                {
                  ...
                  alt: 'Austria Flag',
                  text: $t('common.product.shippingInfo.austria'),
                },
                $t('common.product.shippingInfo.austriaDelivery'),
                '€4.95',
                `${$t(
                  'common.product.shippingInfo.freeShipping'
                )} on orders over €100`,
              ...
              [
                {
                  image:
                    'https://mainfacts.com/media/images/coats_of_arms/ch.png',
                  alt: 'Switzerland Flag',
                  text: $t('common.product.shippingInfo.switzerland'),
                },
                $t('common.product.shippingInfo.switzerlandDelivery'),
                '€9.95',
                '-',
              ],
            ]"
            :returnsInfo="{
              ...
              link: {
                url: '#',
                text: $t('common.product.shippingInfo.returnsPortal'),
              },
            }"
          />
        </template>
