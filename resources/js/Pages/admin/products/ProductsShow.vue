<template>
  <PageLayout
    ...
    :button="{ title: 'Add New Product', click: true }"
  >
    <!-- card header -->
    <div
    ...
    >
      ...
      >
        <span class="mr-3 font-semibold text-dark"
          >All Products ({{ data?.meta.total ?? 0 }})</span
        >
        ...
        <table class="w-full my-0 align-middle text-dark border-neutral-200">
          <thead class="align-bottom">
            <tr class="font-semibold text-[0.95rem] text-gray">
              ...
              <th class="p-3 text-start min-w-[175px] uppercase">category</th>
              <th class="p-3 text-start min-w-[175px] uppercase">UPDATED AT</th>
            </tr>
          </thead>
          <tbody>
              ...
              >
                ...
                <td class="p-3">
                  <input
                    ...
                    id="name"
                    @change="
                      (e) => handleUpdate(product, 'name', e.target.value)
                    "
                ...
                <td class="p-3 text-start">
                  <ProductDescription
                    ...
                    @handle:update="
                      (value) => handleUpdate(product, 'description', value)
                    "
                  />
                </td>
                <td class="p-3 text-start">
