  ...
  <div v-if="editor" class="shadow-xl rounded-xl me-5">
    <div class="control-group">
      ...
      >
        ...
        >
          <button
            class="text-slate-400 p-1 hover:text-slate-500 hover:bg-slate-100 rounded focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300"
          ...
          <button
            ...
            :class="{ 'bg-slate-100': editor.isActive('paragraph') }"
          ...
          <button
            ...
            :class="{
              'bg-slate-100': editor.isActive('heading', { level: 1 }),
            }"
          ...
          <button
            ...
            :class="{
              'bg-slate-100': editor.isActive('heading', { level: 2 }),
            }"
          ...
          <button
            ...
            :class="{
              'bg-slate-100': editor.isActive('heading', { level: 3 }),
            }"
          ...
          <button
            ...
            :class="{
              'bg-slate-100': editor.isActive('heading', { level: 4 }),
            }"
          ...
          <button
            ...
            :class="{
              'bg-slate-100': editor.isActive('heading', { level: 5 }),
            }"
          ...
          <button
            ...
            :class="{
              'bg-slate-100': editor.isActive('heading', { level: 6 }),
            }"
          ...
          <input
            type="color"
            class="h-8 w-8 rounded-full border-0 focus-visible:ring focus-visible:ring-indigo-300"
            @change="
              (e) => editor.chain().focus().setColor(e.target.value).run()
            "
          />
        </div>
      </div>
    ...
    <editor-content
      :editor="editor"
      class="w-full text-sm text-slate-600 placeholder:text-slate-400 px-3 sm:px-3 py-3 resize-none focus:outline-none min-h-32"
    />
    <footer>
      <div
      ...
      >
        ...
        >
          ...
          <div class="flex items-center">
            ...
            >
              <button
                class="flex justify-center items-center size-8 text-red-400 hover:text-red-500 hover:bg-slate-100 rounded focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300"
