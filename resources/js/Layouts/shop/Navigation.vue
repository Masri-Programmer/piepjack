<template>
  <header ref="navigation" class="bg-accent_dark border-b border-gray">
    <TopBanner />
    <div class="navigation-bar">
      ...
      <div class="nav-links" @mouseleave="closeDropdown">
        <router-link to="/" class="nav-item border-animate">
          <span @mouseleave="closeDropdown">{{ $t("common.menu.home") }}</span>
        </router-link>
    ...
    <transition name="fade">
      <div
        ...
        @mouseover="openDropdown('COLLECTIONS')"
      >
        <transition-group name="fade-up" tag="div" class="dropdown-content">
          <template v-for="(collection, index) in data.data" :key="index">
            <router-link
